...
{
    public interface IMastodonServiceSetup
    {
    ...
    public class MastodonServiceSetup : IMastodonServiceSetup
    {
        ...
        #region Ctor
        public MastodonServiceSetup(IInstancesRepository instancesRepository)
        {
